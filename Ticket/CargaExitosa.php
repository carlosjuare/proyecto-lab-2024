...
if ($result_tipo_usuario->num_rows > 0) {
    ...
    $url_destino = ($tipo_usuario == 'administrador') ? '../Panel/administradorPanel.php' : '../Panel/usuarioPanel.php';
} else {
...
<div class="container">
    ...
    <div id="container-central-car-exitosa" class="content">
        <div class="message">
            <h2 class="mb-4">Carga Exitosa</h2>
