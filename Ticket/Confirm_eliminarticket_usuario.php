...
$url_destino = '../eliminar_ticket_usuario.php';
?>
...
<div class="container">
    <div id="container-central-areas">
        ...
        <div class="text-center content">
            <a href="eliminar_ticket_usuario.php?id=<?php echo $id_ticket; ?>" class="btn-rojo">Eliminar</a>
            <a href="mostrar_tabla_usuario.php" class="btn-azul">Cancelar</a>
        </div>
    </div>
</div>
<footer>
