...
<div class="container">
    <div id="container-central-areas">
        <div class="message">
            ...
            <p>¿Estás seguro de que deseas eliminar este area?</p>
        </div>
        <div class="text-center">
            <a href="eliminar-areas.php" id=<?php echo $id_ticket; ?>" class="btn-rojo">Eliminar</a>
            <a href="mostrar-areas.php" class="btn-azul">Cancelar</a>
        </div>
    </div>
</div>
<footer>
